   ...
   <body class="main-layout">
                           ...
                           <div class="collapse navbar-collapse" id="navbarsExample04">
                              <ul class="navbar-nav mr-auto">
                                 <li class="nav-item ">
                                  ...
                                  <!--   <a class="nav-link" href="CloudServerHome2.jsp">User Home</a>
                                 </li> 
                                 <li class="nav-item ">
                               
                                    <a class="nav-link" href="AddUsers2.jsp">Add User's</a>
                                 </li> 
                                 <li class="nav-item ">
                                    <a class="nav-link" href="UsersData2.jsp">User Data</a>
                                   <li>
                                    
                                 <li class="nav-item">
                                    <a class="nav-link" href="CloudUsersInfo2.jsp">User Details</a>
                                 </li> -->
     ...
     <div id="about"  class="about">
         ...
         <div class="row d_flex">
               <div class="col-md-7">  
                  <div class="titlepage">
               <h1 class="carousel-title">Server2 Info</h1>
                    <br><br>
