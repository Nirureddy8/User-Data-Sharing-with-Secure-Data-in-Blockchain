...
public class Store extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*
		 Scanner s = new Scanner(photo).useDelimiter("\\A");
		 String result = s.hasNext() ? s.next() : "";
		 System.out.println("the content in file"+result);
		 
		String encText= Test.encryption(result,  "abdfsajfklsaadcv");
		...
		if(i > 0){
			...
			o.println("alert('Message Stored Successfully..');");
